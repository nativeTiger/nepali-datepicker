...
# pnpm
pnpm add nepali-datepicker

# yarn
yarn add nepali-datepicker
```
...
export default {
  content: [
    "./src/**/*.{ts,tsx}",
    "./node_modules/nepali-datepicker/dist/**/*.js", // ← add this
  ],
};
```
...
```tsx
import { NepaliCalendar } from "nepali-datepicker";
...
```tsx
import { TimePicker } from "nepali-datepicker";
import type { TimeValue } from "nepali-datepicker";
